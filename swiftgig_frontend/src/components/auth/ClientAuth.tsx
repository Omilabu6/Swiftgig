        ...
        <div className="max-w-4xl mx-auto">
          ...
          {currentStep === 1 && (
            <div>
              ...
              <p className="text-gray-400 mb-8">
                A professional photo helps you build trust with talents. To keep things safe and simple, they'll receive payments through us - which is why we need your personal information.
              </p>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-red-400 text-sm mt-1">
                      You must be at least 18 years old to join SwiftGig as a client.
                    </p>
                  </div>
          ...
          {currentStep === 2 && (
            <div>
              ...
              <p className="text-gray-400 mb-8">
                To ensure the safety and security of our platform, we require all clients to verify their identity. Please upload a clear copy of one of the accepted identification documents.
              </p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-gray-400 text-sm space-y-1 list-disc list-inside">
                        ...
                        <li>We accept only government-issued IDs</li>
