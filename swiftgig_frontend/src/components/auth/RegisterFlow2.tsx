...
export default function RegisterFlow2() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex justify-between items-center px-8 py-6 border-b border-gray-200">
        ...
        <div className="flex items-center gap-4">
          <span className="text-gray-600">Here to hire talent?</span>
          <button
      ...
      <div className="max-w-md mx-auto px-4 py-12">
        ...
        <div>
          ...
          <div className="mb-6">
            <button
              type="button"
              className="w-full py-3 px-4 bg-[#4285F4] text-white rounded-full font-medium hover:bg-[#357ae8] transition-all flex items-center justify-center gap-2"
            >
